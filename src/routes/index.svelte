...
<main class="layout">
  ...
  <p class="text_small">This is Small Text using a class</p>
  ...
  <form>
    <div class="grid cols-3">
      <div>
        ...
        <input id="text" type="text" placeholder="Type Your Name" />
      </div>
    ...
    <div>
      ...
      <textarea id="message">The cat was playing in the garden.</textarea>
    </div>
